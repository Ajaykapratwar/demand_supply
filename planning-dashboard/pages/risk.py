...
from data.mock_data import risk_kpis, risk_probability_impact, mitigation_actions

register_page(__name__, path="/risk", name="Risk Monitoring")

_kpis   = risk_kpis()
_pi     = risk_probability_impact()
_mit    = mitigation_actions()

_gauge_fig = go.Figure(go.Indicator(
    mode="gauge+number", value=0.62,
